...
//
//
//lecture - i2c-eeprom - this is the object used to instantiate each device instance
//                       in the bsp - such objects are maintained in a table of
//                       objects
//
//
//
...
//
//
//lecture - i2c-eeprom - transfer control structure - this will be used during the IO transfers
//                       will contain appropriate buffers, if required
//
//
//
...
//
//
//lecture - i2c-eeprom - this is the object that will be used to manage an active
//                       device / a control object - see comments below !!!
//
//lecture - UART - this object is used for the active device/object, as needed
//
...
//aaa-zzz
#define ioctlUSE_TASKNOTIFICATION_TX		6
#define ioctlUSE_TASKNOTIFICATION_RX		7
 ...
 */
//
//lecture - i2c-eeprom - invoke the respective write and read methods
//
//added for mpu-port  ?? why needed??
#define FreeRTOS_write										FreeRTOS_Generic_write
#define FreeRTOS_read										FreeRTOS_Generic_read
#define FreeRTOS_ioctl										FreeRTOS_Generic_ioctl
