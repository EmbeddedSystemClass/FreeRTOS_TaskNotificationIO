...
//aaa-zzz
#define ioconfigUSE_TASK_NOTIFICATION_TX					1
#define ioconfigUSE_TASK_NOTIFICATION_RX					1
...
//aaa-zzz
	#define ioconfigUSE_UART_TASKNOTIFICATION_TX		    1
    #define ioconfigUSE_UART_TASKNOTIFICATION_RX		    1
