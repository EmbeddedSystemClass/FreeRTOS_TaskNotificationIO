...
#define configMAX_PRIORITIES			( 7 )  //aaa-zzz
...
//#define configUSE_IDLE_HOOK				0   //aaa-zzz
...
//
//
//lecture - refer to startup code cr_startip_lpc176x.c and also, refer to
//          port.c - this will complete the dots for managing
//          certain FreeRTOS system ISRs
//
//
//
/* Definitions that map the FreeRTOS port interrupt handlers to their CMSIS
standard names. */
//#define vPortSVCHandler SVCall_Handler   //aaa-zzz
